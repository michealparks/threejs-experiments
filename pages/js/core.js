...
import * as THREE from 'https://cdn.jsdelivr.net/npm/three@v0.122.0/build/three.module.js'
import { GLTFLoader } from 'https://cdn.jsdelivr.net/npm/three@v0.122.0/examples/jsm/loaders/GLTFLoader.js'
import { OrbitControls } from 'https://cdn.jsdelivr.net/npm/three@v0.122.0/examples/jsm/controls/OrbitControls.js'
import { EffectComposer } from 'https://cdn.jsdelivr.net/npm/three@v0.122.0/examples/jsm/postprocessing/EffectComposer.js'
import { RenderPass } from 'https://cdn.jsdelivr.net/npm/three@v0.122.0/examples/jsm/postprocessing/RenderPass.js'
import { UnrealBloomPass } from 'https://cdn.jsdelivr.net/npm/three@v0.122.0/examples/jsm/postprocessing/UnrealBloomPass.js'
import { ShaderPass } from 'https://cdn.jsdelivr.net/npm/three@v0.122.0/examples/jsm/postprocessing/ShaderPass.js'
import { FXAAShader } from 'https://cdn.jsdelivr.net/npm/three@v0.122.0/examples/jsm/shaders/FXAAShader.js'
